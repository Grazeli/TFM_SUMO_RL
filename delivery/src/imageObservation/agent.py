...
class DQN:
    ...
    def define_model(self):
        """
        Function to define the agent neural network in this case a convolutional neural network

        :return: None
        """
        inputs = keras.Input((self.state_size[1], self.state_size[2], self.state_size[3], 1))

...
class Configuration():
    ...
    def _recursive_make_dict(self, recursive_root):
        """
        This function is called recursively in order to convert the xml tree into a dictionary
    ...
    def get(self, keys):
        ...
        :param list | string keys: List of keys within the configuration file to access the wanted information
